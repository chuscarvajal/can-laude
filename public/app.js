document.addEventListener('DOMContentLoaded', () => {
  ...
  const saved = localStorage.getItem('cltheme');
  ...
  if (themeToggle) {
    themeToggle.addEventListener('click', () => {
      ...
      localStorage.setItem('cltheme', next);
    });
  }
  ...
  const quizResults = {
    basico: {
      ...
      waText: "Hola%2C%20el%20consultor%20de%20Can%20laude%20me%20ha%20recomendado%20el%20adiestramiento%20b%C3%A1sico%20y%20quiero%20m%C3%A1s%20informaci%C3%B3n."
    },
    conducta: {
    ...
    domicilio: {
      ...
      desc: "Trabajar en el entorno del perro acelera el aprendizaje y facilita la consolidación de los hábitos. Vamos a tu casa en Madrid.",
    ...
    general: {
      ...
      waText: "Hola%2C%20quiero%20informaci%C3%B3n%20sobre%20el%20adiestramiento%20canino%20en%20Madrid."
    }
  };
  ...
  function showResults() {
    ...
    if (btnWaResult) btnWaResult.href = `https://wa.me/34626129464?text=${res.waText}`;
  }
  ...
  function calculate() {
    ...
    if (waCalcBtn) {
      ...
      waCalcBtn.href = `https://wa.me/34626129464?text=${msg}`;
    }
  }
